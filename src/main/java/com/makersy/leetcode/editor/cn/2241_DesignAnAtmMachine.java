...
// 
//
// Related Topics 贪心 设计 数组 👍 30 👎 0


package com.makersy.leetcode.editor.cn;

class DesignAnAtmMachine {

    public static void main(String[] args) {
        //Solution solution = new DesignAnAtmMachine().new Solution();
    }
    ...
    class ATM {
        ...
        private void add(int[] banknotesCount) {
