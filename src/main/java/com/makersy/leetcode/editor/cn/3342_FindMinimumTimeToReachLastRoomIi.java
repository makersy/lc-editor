 ...
 * <p>
 * 给你一个大小为 n x m 的二维数组 moveTime ，其中 moveTime[i][j] 表示在这个时刻 以后 你才可以 开始 往这个房间 移动 。你在
 * 时刻 t = 0 时从房间 (0, 0) 出发，每次可以移动到 相邻 的一个房间。在 相邻 房间之间移动需要的时间为：第一次花费 1 秒，第二次花费 2 秒，第
 * 三次花费 1 秒，第四次花费 2 秒……如此 往复 。
...
class FindMinimumTimeToReachLastRoomIi {
    public static void main(String[] args) {
        //Solution solution = new FindMinimumTimeToReachLastRoomIi().new Solution();
    }
